...
const Footer = () => {
   ...
   <footer className="max-w-6xl lg:mx-auto mx-4 bg-purple-200 text-black p-6 mb-1 rounded-sm">
        ...
        <aside className="container flex flex-col md:flex-row justify-between items-center gap-2">
            <div className="md:w-1/2 w-full">
                <img src={footerLogo} alt="Logo" className="mb-3 w-16" />
                <ul className="flex flex-col md:flex-row md:gap-4 gap-2 text-[1rem] font-light">
        ...
        <aside className="container flex flex-col md:flex-row justify-between items-center mt-5 border-t border-gray-700 pt-6">
        
            <ul className="flex gap-6 mb-4 md:mb-0">
                <li><a href="#privacy" className="hover:text-primary">Privacy Policy</a></li>
                <li><a href="#terms" className="hover:text-primary">Terms of Service</a></li>
            </ul>
            <p className='text-[15px]'>&copy; 2025, Developed By Parvesh </p>
