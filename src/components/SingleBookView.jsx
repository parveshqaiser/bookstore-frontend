            ...
            <section className='grid grid-cols-1 md:grid-cols-3 gap-6 border-b-rounded-lg shadow-lg p-6'>
                ...
                <div className="space-y-3 mt-2 md:mt-0 md:space-x-0 space-x-2">
                    ...
                    <button
                        ...
                        className={`w-48  border border-purple-600 text-purple-600 py-2 rounded-md font-semibold transition-all  ${singleBook?.isAvailable ? "cursor-pointer" : "line-through cursor-not-allowed"}`}
                    >
                        Add to Cart
                    </button>
                    ...
                    <button
                        disabled={!singleBook?.isAvailable}
                        className={`w-48 border border-green-800 text-green-700  py-2 rounded-md font-semibold transition-all  ${singleBook?.isAvailable ? "cursor-pointer" : "line-through cursor-not-allowed"}`}
                    >
                        Buy Now
                    </button>
                </div>
