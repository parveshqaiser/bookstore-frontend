...
// className='max-w-6xl md:mx-auto my-10 mx-4 shadow-sm pb-4 relative bg-white'
    return (
    <main className='flex justify-center items-center min-h-screen bg-gradient-to-br from-amber-50 to-orange-100'>

        <div className='shadow-sm bg-white p-3 w-full max-w-6xl relative'>
