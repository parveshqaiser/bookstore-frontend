...
const NewArrivals = ({allBooks, isLoading}) => {
    ...
    {
        return(    
        <section className="flex gap-x-1 w-[350px] items-center p-3 shadow-md hover:shadow-xl rounded-lg bg-[#F9FBFC]">
            <nav className="w-[115px] h-44 flex-shrink-0 border border-gray-300 p-1 transition-transform transform hover:scale-[1.1] hover:cursor-pointer">
    ...
    return (
    <main className='max-w-[1160px] my-20 lg:mx-auto mx-4'>
